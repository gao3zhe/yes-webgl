...
SceneTransforms.prototype.calculatePerspective = function() {
    ...
    mat4.perspective(30, c_computed_width / c_computed_height, 0.1, 1000.0, this.pMatrix);
};
...
SceneTransforms.prototype.updatePerspective = function() {
    mat4.perspective(30, c_computed_width / c_computed_height, 0.1, 1000.0, this.pMatrix); // We can resize the screen at any point so the perspective matrix should be updated always.
};
