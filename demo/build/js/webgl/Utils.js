var Utils = {
    ...
    getGLContext: function(name) {
        ...
        if (canvas == null) {
            ...
            c_computed_width = parseInt(getComputedStyle(canvas).width);
            c_computed_height = parseInt(getComputedStyle(canvas).height);

            console.log('%c The canvas\' size is: %i %i [Utils.js] ','color:skyblue; line-height:2.5em;', c_width, c_height);
        }
